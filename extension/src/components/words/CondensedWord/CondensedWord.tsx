...
export const CondensedWord = CSSModules(
  function ({ details }: { details: Detail[] }) {
    ...
    return details.map((detail: Detail, index: number) => {
      return (
        <div key={index} styleName="word">
          <div styleName="word__top">
            <div styleName="word__title">
              ...
              <ul styleName="word__phonetics">
                {detail.phonetics &&
                  detail.phonetics.map((phonetic: Phonetic, index: number) => {
                    return (
                      <li key={index} styleName="word__phonetic">
                        ...
                        {phonetic.audio && (
                          ...
                          >
                            <span styleName="word__text">Pronounce word</span>
