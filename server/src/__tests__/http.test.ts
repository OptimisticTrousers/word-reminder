...
describe("http", () => {
  ...
  describe("invalid url", () => {
    it("calls the get method", async () => {
      await expect(http.get("www.example.com")).rejects.toThrow("Invalid URL");
    });

    it("calls the post method", async () => {
      await expect(http.post("www.example.com")).rejects.toThrow("Invalid URL");
    });

    it("calls the put method", async () => {
      await expect(http.put("www.example.com")).rejects.toThrow("Invalid URL");
    });

    it("calls the remove method", async () => {
      await expect(http.remove("www.example.com")).rejects.toThrow(
        "Invalid URL"
      );
    });
  });
  ...
  describe("no options and params", () => {
    it("calls the get method with no options and params", async () => {
      ...
      const response = await http.get(url, { partOfSpeech: "noun" });
    ...
    it("calls the post method with no options and params", async () => {
      ...
      const response = await http.post(url, { partOfSpeech: "noun" });
    ...
    it("calls the put method with no options and params", async () => {
      ...
      const response = await http.put(url, { partOfSpeech: "noun" });
    ...
    it("calls the remove method with no options and params", async () => {
      ...
      const response = await http.remove(url, { partOfSpeech: "noun" });
